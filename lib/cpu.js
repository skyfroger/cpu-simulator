...
$(function() {
	...
	tippy('#reg_pc', {
		content: "<strong>Счётчик команд (Program Counter) всегда содержит адрес инструкции, которая будет выполняться следующей",
		allowHTML: true,
		delay: [500,0],
	});
	...
	tippy('#reg_cir', {
		content: "<strong>Регистр команд (Instruction Register)</strong> хранит инструкцию, которую в данный момент должен выполнить процессор. Команда, записанная в виде двоичного числа, определяет, какие команды <strong>Блок управления</strong> будет давать процессору.",
		allowHTML: true,
		delay: [500,0],
	});
