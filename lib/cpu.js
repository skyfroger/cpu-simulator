...
var cpu = {
	...
	init: function(jqCPU) {
		...
		html += getRegisterHtml('MAR', 0, "Регистр адреса памяти");
		html += getRegisterHtml('MDR', 0, "Регистр данных");
		html += getRegisterHtml('ACC', 0, "Аккумулятор");
		html += getRegisterHtml('CIR', 0, "Регистр текущей операции");
