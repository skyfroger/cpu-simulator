...
var cpu = {
	...
	updateAnnotations: function() {
		...
		connect({e:CPU, h:"right", v:"5%"}, {e: RAM, h:"left"}, {"stroke-width": 20, "stroke": "#F00", "arrow-end":"block-narrow-short"}, "Адресная шина", {fill: '#fff', font: '15px Arial'});
		connect({e:CPU, h:"right", v:"56%"}, {e: RAM, h:"left"}, {"stroke-width": 20, "stroke": "#F00", "arrow-end":"block-narrow-short", "arrow-start": "block-narrow-short"}, "Шина данных", {fill: '#fff', font: '15px Arial'});
		connect({e:CPU, h:"right", v:"85%"}, {e: RAM, h:"left"}, {"stroke-width": 20, "stroke": "#F00", "arrow-end":"block-narrow-short", "arrow-start": "block-narrow-short"}, "Шина управления", {fill: '#fff', font: '15px Arial'});
	},
